...
class _BookingItemComponentState extends State<BookingItemComponent> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      width: context.width(),
      decoration: BoxDecoration(color: Theme.of(context).cardColor, borderRadius: radius(24)),
      child: Column(
        children: [
          Row(
                ...
                children: [
                    ...
                    children: [
                      ...
                      if (widget.bookingData.status != BookingStatusKeys.refund)
                        Row(
                          ...
                          children: [
                            Text(
                              widget.bookingData.isPaid ? language.paid : (appStore.isArabic ? 'غير مدفوع' : 'Unpaid'),
                              style: boldTextStyle(
                                color: widget.bookingData.isPaid ? Colors.green : Color(0xFFe04f5f),
                              ),
                            ).paddingBottom(6),
                            6.width,
                            Image.asset(
                              widget.bookingData.isPaid ? 'assets/icons/paid.png' : 'assets/icons/unpaid.png',
                              width: 30,
                              color: greenColor,
                            ),
                          ],
                  ...
                  Row(
                    children: [
                      ...
                      Text('${language.lblBookingID} #${widget.bookingData.id.validate()}', style: boldTextStyle(color: appStore.isDarkMode ? white : primaryColor)),
                    ],
                  ),
                    ...
                    Row(
                      ...
                      children: [
                        PriceWidget(
                          ...
                          // price: widget.bookingData.totalAmount.validate(),
                          price: widget.bookingData.finalCouponDiscountAmount != null ? (widget.bookingData.totalAmount! - widget.bookingData.finalCouponDiscountAmount!) : widget.bookingData.totalAmount.validate(),
            ...
            child: Column(
              children: [
                Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Text('${language.lblDate} & ${language.lblTime}', style: boldTextStyle(color: Color(0xFF6D7698))),
                    8.width,
                    Text(
                  ...
                  Column(
                    children: [
                      ...
                      Row(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Text(language.textProvider, style: boldTextStyle(color: Color(0xFF6D7698))),
                          8.width,
                  ...
                  Column(
                    children: [
                      ...
                      Row(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(language.textHandyman, style: boldTextStyle(color: Color(0xFF6D7698))),
                          Text(widget.bookingData.handyman!.validate().first.handyman!.displayName.validate(), style: boldTextStyle(size: 12)).flexible(),
                        ],
                      ).paddingAll(8),
                    ],
                  ),
                if (widget.bookingData.paymentStatus != null && (widget.bookingData.status == BookingStatusKeys.complete || widget.bookingData.paymentStatus == SERVICE_PAYMENT_STATUS_ADVANCE_PAID || widget.bookingData.paymentStatus == SERVICE_PAYMENT_STATUS_PAID))
                  Column(
                    children: [
                      Divider(height: 0, color: context.dividerColor),
                      Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(language.paymentStatus, style: boldTextStyle(color: Color(0xFF6D7698))).expand(),
                          Text(
                            ...
                            style: boldTextStyle(size: 12, color: widget.bookingData.paymentStatus == SERVICE_PAYMENT_STATUS_ADVANCE_PAID || (widget.bookingData.paymentStatus == SERVICE_PAYMENT_STATUS_PAID || widget.bookingData.paymentStatus == PENDING_BY_ADMIN) ? Colors.green : Colors.red),
                          ),
                        ],
                      ).paddingAll(8),
                    ],
