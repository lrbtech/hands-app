...
class _BookServiceScreenState extends State<BookServiceScreen> {
  ...
  void setPrice() {
    ...
    if (bookingAmountModel.finalSubTotal.isNegative) {
      ...
      advancePaymentAmount = (bookingAmountModel.finalGrandTotalAmount * (widget.data.serviceDetail!.advancePaymentPercentage.validate() / 100).toStringAsFixed(getIntAsync(PRICE_DECIMAL_POINTS)).toDouble());
    }
    setState(() {});
  }
