            ...
            Row(
              ...
              children: [
                ...
                if (widget.data.validate().isNotEmpty)
                  Row(
                    children: [
                      Text('${language.lblID}:', style: boldTextStyle(color: appStore.isDarkMode ? white : primaryColor)),
                      4.width,
                      Text(' #' + widget.data[0].bookingId.validate().toString(), style: boldTextStyle(color: appStore.isDarkMode ? white : primaryColor)),
                    ],
                  )
              ],
            ),
