...
class _BidderItemComponentState extends State<BidderItemComponent> {
  ...
  final TextEditingController counterOfferPriceController = TextEditingController();
  ...
  Future<void> savePostJobReq() async {
    ...
    showCustomConfirmDialog(
      ...
      title: '${language.doYouWantToAssign} ${widget.data.provider!.displayName.validate()} ${appStore.selectedLanguageCode == 'en' ? '?' : '؟'}',
      subTitle: appStore.selectedLanguageCode == 'en' ? otherSettingStore.disclimerText.validate() : otherSettingStore.disclimerTextAr.validate(),
      ...
      onAccept: (c) async {
        ...
        Map bookingRequest = {
          ...
          BookingServiceKeys.description: widget.postJobData.description.validate(),
          CommonKeys.address: widget.postJobData.address!.address.validate().toString(),
          CommonKeys.date: widget.postJobData.date.validate(),
          BookService.amount: widget.data.price,
          BookService.quantity: 1,
          BookingServiceKeys.totalAmount: widget.data.price.validate().toStringAsFixed(getIntAsync(PRICE_DECIMAL_POINTS)),
        ...
        await savePostJob(request).then((value) {
          bookingRequest.putIfAbsent("post_request_id", () => widget.postRequestId);
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: Icon(
                                  widget.data.provider?.providerType?.toLowerCase() == 'company'
                                      ? CupertinoIcons.bag_fill
                                      : widget.data.provider?.gender == 'male'
                                          ? Icons.man
                                          : widget.data.provider?.gender == 'female'
                                              ? Icons.woman
                                              : Icons.circle,
                                  size: 18,
                                  color: widget.data.provider?.providerType?.toLowerCase() == 'company'
                                      ? black
                                      : widget.data.provider?.gender == 'male'
                                          ? Color(0xFF518EF8)
                                          : widget.data.provider?.gender == 'female'
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.data.provider?.providerType?.toLowerCase() == 'individual'
                                  ? (appStore.selectedLanguageCode == 'en' ? 'Individual' : 'فردي')
                                  : widget.data.provider?.providerType?.toLowerCase() == 'company'
                                      ? (appStore.selectedLanguageCode == 'en' ? 'Company' : 'شركة')
                                      : '',
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                5.width,
                                Text(
                                  widget.data.provider!.providersServiceRating.toString(),
                                  style: boldTextStyle(),
                                ),
                                5.width,
                                Text(
                        ...
                        Column(
                          ...
                          children: [
                            Tooltip(
                              message: appStore.selectedLanguageCode == 'en' ? 'Profile' : 'الملف الشخصي',
                            ...
                            Row(
                              children: [
                                ...
                                PriceWidget(
                                  ...
                                  color: widget.fromRealTime ? (widget.bestPrice ? Color(0xFF2AB749) : Color(0xFF961D1D)) : (appStore.isDarkMode ? white : context.primaryColor),
                                ),
                              ],
                            ),
                          ],
                      ...
                      if (widget.postJobData.providerId == null)
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: AppButton(
                                ...
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Icon(Icons.thumb_up_alt_outlined, color: white, size: 16),
                                    4.width,
                                    Text(language.acceptOffer, style: boldTextStyle(color: white, size: 12)),
                                  ],
                                ),
                                color: greenColor,
                                onTap: () {
                            ...
                            if (widget.postJobData.price.validate() != widget.bidderPrice.validate()) 10.width,

                            // Counter offer
                            if (widget.postJobData.price.validate() != widget.bidderPrice.validate())
                              Expanded(
                                child: AppButton(
                                  padding: EdgeInsets.zero,
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: boldTextStyle(color: !appStore.isDarkMode ? white : context.primaryColor, size: 12),
                                      ),
                                    ],
                                  ),
                                  color: appStore.isDarkMode ? white : context.primaryColor,
                                        ...
                                        content: Form(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                language.counterOfferDescription,
                                              ...
                                              // Price Field.
                                              TextFormField(
                                                controller: counterOfferPriceController,
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  hintText: language.counterOfferPrice,
                                                  ...
                                                  focusedErrorBorder: OutlineInputBorder(
                                                    borderRadius: BorderRadius.circular(12),
                                                    borderSide: BorderSide(color: appStore.isDarkMode ? white : context.primaryColor),
                                                  ),
                                                ),
                                              ),
                                              ...
                                              SizedBox(
                                                ...
                                                child: AppButton(
                                                  padding: EdgeInsets.zero,
                                                  child: Text(language.counterOfferTitle, style: boldTextStyle(color: white, size: 12)),
                                                  color: greenColor,
                                                  onTap: () {
