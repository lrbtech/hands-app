        ...
        return Column(
          ...
          children: [
            ...
            GridView.builder(
              ...
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(childAspectRatio: .65, crossAxisCount: 3, mainAxisSpacing: 6, crossAxisSpacing: 6),
              itemBuilder: (_, index) {
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                Marquee(
                                  child: Text(
                                    appStore.selectedLanguageCode == 'en' ? '${data.name.validate()}' : data.nameAr.validate(),
